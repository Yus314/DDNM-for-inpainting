...
def main():
    # Load UNCONDITIONAL nine-patch configuration with t_T=100
    ...
    print(f"   🎯 class_cond = {conf.class_cond} (UNCONDITIONAL)")
    ...
    # UNCONDITIONAL: No class ID
    print("🎨 Unconditional generation: No class label guidance")

    model_kwargs = {
        'gt': gt,
        'gt_keep_mask': gt_keep_mask,
        'deg': 'inpainting',
        'save_path': 'center_hole_inpainting_uncond',
        'y': None,  # UNCONDITIONAL: No class guidance
        'scale': 1,
        'resize_y': False,
        'sigma_y': 0.0,
        'conf': conf
    ...
    print("📁 Results saved to results/center_hole_inpainting_uncond/")
    print("🔬 Compare with:")
    print("   - Conditional (t_T=100): results/center_hole_inpainting_t100/")
    print("   - Original (t_T=25): results/center_hole_inpainting_results/")
