...
"""
Enhanced Nine-Patch Inpainting テストスクリプト
詳細保存機能付きの強化版九分割inpaintingをテスト
"""
...
def main():
    # Load enhanced nine-patch configuration
    ...
    print(f"Enhanced nine-patch mode enabled: {conf.nine_patch_mode}")
    ...
    model_kwargs = {
        ...
        'deg': 'inpainting',
        'save_path': 'test_enhanced_nine_patch_results',
        'y': class_id,
        'scale': 1,
        'resize_y': False,
        'sigma_y': 0.0,
    ...
    # Generate inpainted result using enhanced nine-patch system
    print("🚀 Starting Enhanced Nine-Patch Inpainting with detailed saving...")

    with torch.no_grad():
        try:
            # Use integrated enhanced progressive loop
            sample = None
    ...
    print("✅ Enhanced Nine-Patch Inpainting completed!")
    print("📁 Results saved with detailed structure:")
    print("  📂 results/test_enhanced_nine_patch_results/")
    print("    📂 input/           - Original, mask, and masked input images")
    print("    📂 patches/         - Individual patch processing details")
    print("      📂 patch_00/      - Patch 0 (top-left)")
    print("        📂 progressive/  - Progressive sampling steps (GIF animation)")
    print("        📄 input.png     - Patch input image")
    print("        📄 mask.png      - Patch mask")
    print("        📄 result.png    - Patch final result")
    print("      📂 ...             - Patches 01-08")
    print("    📂 blending/        - Step-by-step blending visualization")
    print("    📂 metadata/        - Configuration and timing data (JSON)")
    print("    📂 final/           - Final 512x512 result")
    print("🎯 Method: Enhanced nine-patch with comprehensive saving")

    # Display summary of saved files
    results_path = "results/test_enhanced_nine_patch_results"
